...
public class OfficeMain {
	...
	private List<Office> createOffices(){
		...
		Office of1 = new Office("Ranchi", "9992344910", "Ratu Road Ranchi", "Hinoo Doranda Ranchi",
				"Jharkhand", "India", "834011", "Pvt Area", null);
		
		Office of2 = new Office("Bangalore", "7777777910", "Majestic", "Kormangala Bangalore",
				"Karnatka", "India", "659014", "Govt Area", null);
		
		Office of3 = new Office("Delhi", "6754244910", "Chandani Chowk", "New Delhi",
				"Delhi", "India", "765351", "Local Area", null);
